...
**Team Name:** Pro  
**Github:** https://github.com/UTSCCSCC01/finalprojects22-pro-group 
...
## competition.md (Max 2 marks)
  ...
  competition.md Total Mark: 1 / 2 Feedback: Grammatical issues 
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  - Relevant persona clearly identified for each user story (max 2 marks) 
    ...
    Your mark: 1 Feedback: There are only users, what about other roles like developer?
...
## Documentation: README.md (max 3 marks)
  - Motivation and Project Description
    ...
    Your mark: 0 Feedback: Grammatical issue, and vague description (copied from summary.md).
...
## Definition of done: done.md (max 2 marks)
  ...
  done.md Total Mark: 1 / 2 Feedback: What does done mean in terms of your stock market app?
...
## Process: process.md (max 10 marks)
  - Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1 Feedback: What was each person's role during Sprint 0? Student A did personas, Student B did readme, etc.
