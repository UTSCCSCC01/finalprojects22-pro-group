...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 2 Feedback: more detail needed in responsibilities 
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
	...
	Your Mark: 5 Feedback: only 1 feature (login) shown. For future sprints please show at least 4 - 5 features. Recommendation: Perhaps, let those who worked on implementing the feature talk. 
