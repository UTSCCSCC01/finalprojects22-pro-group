...
from ib_insync.order import (
    BracketOrder, LimitOrder, Order, OrderState, OrderStatus, MarketOrder, StopOrder, StopLimitOrder, Trade)
...
class IB:
    ...
    **user code may not block for too long**.
    ...
    def customBracketOrder(self, action: str, quantity: float,
